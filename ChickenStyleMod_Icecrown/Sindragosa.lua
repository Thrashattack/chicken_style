...
if arg9 == 71049 then -- Blistering Cold 25hc Spell ID
	PrepareGP('sindy_blistering', { arg7 }, { 0 })
end
...
function reportfromtridamagetablesp3(inwhichchat,maxpers,qq,bojinterr,iccra,norep,event)
...
PrepareGP('sindy_frost_bomb', vezaxname2, vezaxcrash2)
...
reportfromtridamagetables(whererepiccchat[psicchatchoose[12][7]],12,1,true,nil,nil,'sindy_backlash')
end
end
...
reportfromtridamagetablesp3(whererepiccchat[psicchatchoose[12][8]],12,1,true, nil, nil, 'sindy_backlash')
end
end
...
if psiccinst=="10" or psiccinst=="25" then else
strochkadamageout="{rt4} "..psiccbossfail116f
reportfromtridamagetables(whererepiccchat[psicchatchoose[12][7]],15,nil,true,0,1, 'sindy_backlash')
end

if psiccinst=="10" or psiccinst=="25" then else
strochkadamageout="{rt4} "..psiccbossfail116f3
reportfromtridamagetablesp3(whererepiccchat[psicchatchoose[12][8]],15,nil,true,0,1, 'sindy_backlash')
end
